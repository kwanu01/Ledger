...
const copy = {
  ko: { title: '내 장부', empty: '돈이 드는 일 하나를 적어 보세요.', name: '장부 이름', nameExample: '예: 제주 여행', budget: '예산 (선택)', create: '장부 만들기', newBook: '새 장부', book: '장부', paid: '쓴 돈', planned: '앞으로 쓸 돈', total: '전체 비용', left: '예산에서 남은 돈', over: '예산 초과', add: '항목 추가', item: '무엇에 쓰나요?', itemExample: '예: 숙소', amount: '금액', record: '적기', editEntry: '수정', saveEntry: '수정하기', plan: '예정', done: '결제함', markPaid: '결제했어요', remove: '삭제', removeConfirm: '이 항목을 지울까요?', deleteBook: '장부 삭제', deleteBookConfirm: '이 장부와 기록을 모두 지울까요?', noEntries: '첫 항목을 적으면 여기에 쌓입니다.', changeBudget: '예산 수정', saveBudget: '저장', cancel: '취소', setBudget: '예산 정하기', local: '이 브라우저에 저장됩니다. 다른 기기와는 연결되지 않습니다.', error: '이름과 금액을 확인해 주세요.', storageError: '저장하지 못했습니다. 새로고침하면 기록이 사라질 수 있어요.', currency: '통화' },
  en: { title: 'My books', empty: 'Start with one thing that costs money.', name: 'Book name', nameExample: 'e.g. Japan trip', budget: 'Budget (optional)', create: 'Create book', newBook: 'New book', book: 'Book', paid: 'Paid', planned: 'Still to pay', total: 'Total cost', left: 'Left in budget', over: 'Over budget', add: 'Add an item', item: 'What is it for?', itemExample: 'e.g. hotel', amount: 'Amount', record: 'Add', editEntry: 'Edit', saveEntry: 'Save changes', plan: 'Planned', done: 'Paid', markPaid: 'Mark paid', remove: 'Remove', removeConfirm: 'Remove this item?', deleteBook: 'Delete book', deleteBookConfirm: 'Delete this book and all its entries?', noEntries: 'Your first item will appear here.', changeBudget: 'Edit budget', saveBudget: 'Save', cancel: 'Cancel', setBudget: 'Set a budget', local: 'Saved in this browser only. It will not appear on another device.', error: 'Check the name and amount.', storageError: 'Could not save. Your records may disappear after a refresh.', currency: 'Currency' },
  ja: { title: '自分の帳簿', empty: 'お金がかかることを一つ書いてみましょう。', name: '帳簿名', nameExample: '例：旅行', budget: '予算（任意）', create: '帳簿を作る', newBook: '新しい帳簿', book: '帳簿', paid: '支払済み', planned: 'これから払う', total: '費用合計', left: '予算の残り', over: '予算超過', add: '項目を追加', item: '何に使いますか？', itemExample: '例：宿泊', amount: '金額', record: '追加', editEntry: '編集', saveEntry: '変更を保存', plan: '予定', done: '支払済み', markPaid: '支払った', remove: '削除', removeConfirm: 'この項目を削除しますか？', deleteBook: '帳簿を削除', deleteBookConfirm: 'この帳簿と記録をすべて削除しますか？', noEntries: '最初の項目がここに表示されます。', changeBudget: '予算を編集', saveBudget: '保存', cancel: 'キャンセル', setBudget: '予算を設定', local: 'このブラウザだけに保存されます。他の端末とは同期しません。', error: '名前と金額を確認してください。', storageError: '保存できませんでした。再読み込みすると記録が消える場合があります。', currency: '通貨' },
  zh: { title: '我的账本', empty: '先记下一件需要花钱的事。', name: '账本名称', nameExample: '例如：旅行', budget: '预算（可选）', create: '创建账本', newBook: '新账本', book: '账本', paid: '已支付', planned: '待支付', total: '总费用', left: '预算剩余', over: '超出预算', add: '添加项目', item: '用于什么？', itemExample: '例如：住宿', amount: '金额', record: '添加', editEntry: '编辑', saveEntry: '保存修改', plan: '计划', done: '已支付', markPaid: '标为已支付', remove: '删除', removeConfirm: '删除此项目？', deleteBook: '删除账本', deleteBookConfirm: '删除此账本及其所有记录？', noEntries: '第一笔项目会显示在这里。', changeBudget: '修改预算', saveBudget: '保存', cancel: '取消', setBudget: '设置预算', local: '仅保存在此浏览器，不会同步到其他设备。', error: '请检查名称和金额。', storageError: '无法保存。刷新后记录可能消失。', currency: '货币' },
  es: { title: 'Mis libros', empty: 'Empieza con algo que te va a costar dinero.', name: 'Nombre del libro', nameExample: 'Ej.: viaje', budget: 'Presupuesto (opcional)', create: 'Crear libro', newBook: 'Nuevo libro', book: 'Libro', paid: 'Pagado', planned: 'Por pagar', total: 'Coste total', left: 'Presupuesto restante', over: 'Sobre el presupuesto', add: 'Añadir gasto', item: '¿Para qué es?', itemExample: 'Ej.: hotel', amount: 'Importe', record: 'Añadir', editEntry: 'Editar', saveEntry: 'Guardar cambios', plan: 'Previsto', done: 'Pagado', markPaid: 'Marcar pagado', remove: 'Eliminar', removeConfirm: '¿Eliminar este gasto?', deleteBook: 'Eliminar libro', deleteBookConfirm: '¿Eliminar este libro y todos sus gastos?', noEntries: 'El primer gasto aparecerá aquí.', changeBudget: 'Editar presupuesto', saveBudget: 'Guardar', cancel: 'Cancelar', setBudget: 'Fijar presupuesto', local: 'Se guarda solo en este navegador. No se sincroniza con otros dispositivos.', error: 'Comprueba el nombre y el importe.', storageError: 'No se pudo guardar. Los datos pueden desaparecer al actualizar.', currency: 'Moneda' },
  vi: { title: 'Sổ của tôi', empty: 'Bắt đầu với một việc cần chi tiền.', name: 'Tên sổ', nameExample: 'Ví dụ: chuyến đi', budget: 'Ngân sách (không bắt buộc)', create: 'Tạo sổ', newBook: 'Sổ mới', book: 'Sổ', paid: 'Đã chi', planned: 'Sắp chi', total: 'Tổng chi phí', left: 'Ngân sách còn lại', over: 'Vượt ngân sách', add: 'Thêm khoản', item: 'Chi cho việc gì?', itemExample: 'Ví dụ: khách sạn', amount: 'Số tiền', record: 'Thêm', editEntry: 'Sửa', saveEntry: 'Lưu thay đổi', plan: 'Dự kiến', done: 'Đã trả', markPaid: 'Đã thanh toán', remove: 'Xóa', removeConfirm: 'Xóa khoản này?', deleteBook: 'Xóa sổ', deleteBookConfirm: 'Xóa sổ này và mọi khoản đã ghi?', noEntries: 'Khoản đầu tiên sẽ hiện ở đây.', changeBudget: 'Sửa ngân sách', saveBudget: 'Lưu', cancel: 'Hủy', setBudget: 'Đặt ngân sách', local: 'Chỉ lưu trong trình duyệt này, không đồng bộ với thiết bị khác.', error: 'Kiểm tra tên và số tiền.', storageError: 'Không thể lưu. Dữ liệu có thể mất khi tải lại.', currency: 'Tiền tệ' },
};
...
export default function PersonalBooks({ locale }: { locale: Locale }) {
  ...
  return <section className={styles.root} aria-label={t.title}>
    ...
    {!loaded ? <div className={styles.placeholder} /> : (!book || creating) ? <form className={styles.create} onSubmit={create}>
      {!book && <p>{t.empty}</p>}
      <label>{t.name}<input autoFocus maxLength={60} value={name} placeholder={t.nameExample} onChange={(e) => setName(e.target.value)} required /></label>
      ...
      <form className={styles.add} onSubmit={addEntry}><h2>{editingEntryId ? t.editEntry : t.add}</h2><div className={styles.entryFields}>
        <label>{t.item}<input maxLength={60} placeholder={t.itemExample} value={item} onChange={(e) => setItem(e.target.value)} required /></label>
