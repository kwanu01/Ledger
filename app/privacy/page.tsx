  ...
  return (
    <>
      ...
      <main className="doc">
        ...
        <h2>기기 장부와 연결한 장부</h2>
        <p>
          개인 장부 미리보기에서 만든 장부의 이름, 예산, 항목과 금액은 해당 브라우저에만 저장합니다.
          계정이나 팀 장부에 연결되지 않으며 다른 기기와 동기화되지 않습니다.
          <a href="/personal/preview">개인 장부 미리보기</a>에서 ‘장부 삭제’를 누르면 그 장부의 기록이 지워집니다.
          이전 버전의 개인 계산 기록은 브라우저에 남아 있을 수 있습니다.
          <a href="/personal/previous">이전 개인 기록 화면</a>에서 확인하고 삭제할 수 있습니다.
        </p>
        <p>
