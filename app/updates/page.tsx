...
const releases = [
  {
    date: '2026.09.26',
    title: '첫 화면에 개인 계산을 추가했습니다',
    items: [
      '현재 잔액과 다음 급여일을 적으면 이번 주에 쓸 금액을 몇 가지로 나눠 볼 수 있습니다.',
      '각 금액을 쓰고 남는 돈을 보고 고르거나, 원하는 금액을 직접 적을 수 있습니다.',
      '쓴 돈을 기록하거나 금액을 고칠 수 있습니다. 기록은 이 브라우저에만 남습니다.',
