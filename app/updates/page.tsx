...
const releases = [
  {
    date: '2026.09.26',
    title: '첫 화면에서 지출 전후를 볼 수 있습니다',
    items: [
      '현재 잔액과 예정된 지출을 적고, 하고 싶은 일의 금액을 넣으면 지출 전후에 남는 돈을 비교합니다.',
      '하기로 한 일은 돈에서 미리 빼고, 실제로 결제하면 지출 기록으로 옮깁니다. 미룬 일은 나중에 다시 볼 수 있습니다.',
      '입력한 정보만 반영하며 기록은 이 브라우저에만 남습니다.',
      '바로 정산과 장부 시작도 첫 화면에 다시 놓았습니다.',
    ],
  },
  {
    date: '2026.09.21',
