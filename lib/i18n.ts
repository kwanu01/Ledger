...
const ko: Record<Key, string> = {
  ...
  withdrawDone: '탈퇴했습니다.',
  appleDisconnectManual: 'Apple 계정의 ‘Apple로 로그인’에서 차곡의 사용을 중단해 주세요.',
...
const en: Record<Key, string> = {
  ...
  appleDisconnectManual: 'In your Apple Account, open Sign in with Apple and stop using chagok.',
...
const ja: Record<Key, string> = {
  ...
  withdrawDone: '退会しました。',
  appleDisconnectManual: 'Apple Accountの「Appleでサインイン」でchagokの使用を停止してください。',
...
const zh: Record<Key, string> = {
  ...
  withdrawDone: '账户已注销。',
  appleDisconnectManual: '请在Apple账户的“通过Apple登录”中停止使用chagok。',
  handOverFirst: '转交所有权',
  backHome: '返回',
...
const es: Record<Key, string> = {
  ...
  appleDisconnectManual: 'En tu cuenta de Apple, abre Iniciar sesión con Apple y deja de usar chagok.',
...
const vi: Record<Key, string> = {
  ...
  appleDisconnectManual: 'Trong Tài khoản Apple, mở Đăng nhập bằng Apple và ngừng sử dụng chagok.',
