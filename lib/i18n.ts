...
const en: Record<Key, string> = {
  ...
  helperTitle: 'Sujeungi', helperAsk: 'Ask about this ledger', helperAskWhat: 'What would you like to know',
  helperAskGo: 'Ask', helperReading: 'Reading', helperHide: 'Throw away', helperShow: 'Sujeungi',
...
const ja: Record<Key, string> = {
  ...
  helperTitle: 'スジュンイ', helperAsk: '帳簿について聞く', helperAskWhat: '何が知りたいですか',
  helperAskGo: '聞く', helperReading: '読み中', helperHide: '捨てる', helperShow: 'スジュンイ',
  sortBy: '順序', etc: 'その他',
...
const zh: Record<Key, string> = {
  ...
  helperTitle: '收证儿', helperAsk: '询问这本账本', helperAskWhat: '想知道什么',
  helperAskGo: '问', helperReading: '读取中', helperHide: '丢掉', helperShow: '收证儿',
  sortBy: '排序', etc: '其他',
...
const es: Record<Key, string> = {
  ...
  helperTitle: 'Sujeungi', helperAsk: 'Preguntar sobre el libro', helperAskWhat: 'Qué quieres saber',
  helperAskGo: 'Preguntar', helperReading: 'Leyendo', helperHide: 'Tirar', helperShow: 'Sujeungi',
...
const vi: Record<Key, string> = {
  ...
  helperTitle: 'Sujeungi', helperAsk: 'Hỏi về sổ này', helperAskWhat: 'Bạn muốn biết gì',
  helperAskGo: 'Hỏi', helperReading: 'Đang đọc', helperHide: 'Vứt đi', helperShow: 'Sujeungi',
